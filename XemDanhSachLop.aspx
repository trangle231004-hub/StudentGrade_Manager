<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XemDanhSachLop.aspx.cs" Inherits="DOAN_HQTCSDL.XemDanhSachLop" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container" style="position: relative;">
            ...
            <h2>Xem Danh Sách Lớp</h2>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:Label ID="lblMessage" runat="server" CssClass="notification"></asp:Label>
                    <div class="toolbar">
                        <asp:DropDownList ID="ddlMALOP" runat="server" Width="150px"></asp:DropDownList>
                        <asp:Button ID="btnSearch" runat="server" CssClass="button btn-search" Text="Tìm kiếm" OnClick="btnSearch_Click" />
                    </div>

                    <asp:GridView ID="gvLopDetail" runat="server" CssClass="grid-view" AutoGenerateColumns="False">
                        <Columns>
